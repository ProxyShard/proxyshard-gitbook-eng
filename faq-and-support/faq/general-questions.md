...
## 1. Where are p0f spoofing and operating-system filtering available?
...
On [Standard Residential](../../our-products/residential-proxies/standard-residential.md) and [Unlimited Residential](../../our-products/residential-proxies/unlimited-residential-proxy.md), neither p0f spoofing nor Device OS filtering is supported.
...
## 13. Does Residential proxy traffic expire at the end of the month?

No. Unused traffic does not expire at the end of the month: it remains available until it is fully used. If the traffic runs out, the proxies temporarily stop working, but it's enough to click <mark style="color:purple;">**Add traffic**</mark> in the top-right corner of the order, top up the package, and the proxies will start working again immediately.

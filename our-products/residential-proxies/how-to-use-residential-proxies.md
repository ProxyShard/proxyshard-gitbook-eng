...
# How to add Residential proxies to an application

Let's review what the proxy connection strings from the "<mark style="color:purple;">Proxy list</mark>" field represent.

Step-by-step examples of adding generated proxies to applications are available in the [setup guide](../../setup-guides/getting-started.md).
